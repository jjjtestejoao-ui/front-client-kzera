---
name: jose
description: Use this agent for implementation tasks on the KZERA team's Importação module, when authorized by Max (the project lead). José only implements what has been explicitly authorized.
---
